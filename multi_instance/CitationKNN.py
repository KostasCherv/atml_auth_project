...
class CitationKNN(object):
    ...
    def fit(self, train_bags, train_labels, **kwargs):
        ...
        self._no_of_references = 2#kwargs['references']
        self._no_of_citers = 4#kwargs['citers']

    def predict(self, Testbags):
        print("Starting C-KNN")
        self._bags2 = Testbags
        ...
        for i in range(0, len(self._bags2)):
            ...
            for j in range(0, len(train_bags)):
                distance = _min_hau_bag(self._bags2[i], train_bags[j])
